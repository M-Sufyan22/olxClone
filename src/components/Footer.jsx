                ...
                <div className="footer_col">
                    <section>
                        ...
                        <ul>
                            ...
                            <li><Link to="/shop">Flats for rent</Link></li>
                            <li><Link to="/shop">Jobs</Link></li>
                    ...
                    <section>
                        <h3>About us</h3>
                        <ul>
                            <li><a rel="noreferrer" href="https://www.olxgroup.com/" target="_blank">About OLX Group</a></li>
                            <li><a rel="noreferrer" href="https://blog.olx.com.pk/" target="_blank">OLX Blog</a></li>
                            <li><a rel="noreferrer" href="https://help.olx.com.pk/hc/en-us/requests/new?ticket_form_id=29191" target="_blank">Contact Us</a></li>
                            <li><a rel="noreferrer" href="https://www.surveygizmo.com/s3/4910980/WP-Business-Form?source=Website" target="_blank">OLX for Businesses</a></li>
                        </ul>
                    </section>
                    <section>
                        <h3>OLX</h3>
                        <ul>
                            <li><a rel="noreferrer" href="https://help.olx.com.pk/hc/en-us" target="_blank">Help</a></li>
                            <li><a rel="noreferrer"href="/sitemap/most-popular">Sitemap</a></li>
                            <li><a rel="noreferrer" href="https://help.olx.com.pk/hc/en-us/categories/360000044302-Legal-Privacy-information" target="_blank">Legal &amp; Privacy information</a></li>
                        </ul>
                    </section>
                    <section>
                    <h3>Follow Us</h3>
                    <div className="footer_followsec">
                        <a rel="noreferrer" href="https://www.facebook.com/olxpakistan" target="_blank">
                        <span>
                            <svg viewBox="0 0 1024 1024" fill="rgba(0,47,52,.64)"><path d="M512 85.325c235.648 0 426.667 191.019 426.667 426.667s-191.019 426.667-426.667 426.667c-235.648 0-426.667-191.019-426.667-426.667s191.019-426.667 426.667-426.667zM512 150.605c-199.595 0-361.429 161.792-361.429 361.387 0 199.637 161.835 361.429 361.429 361.429s361.429-161.792 361.429-361.429c0-199.595-161.835-361.387-361.429-361.387zM616.789 301.133v57.6h-61.312c-15.403 0-28.8 14.848-28.8 31.616v0 63.147h90.069v53.845h-90.069v215.509h-67.115v-215.509h-78.592v-53.845h78.592v-74.325c0-42.752 34.517-78.037 76.672-78.037v0h80.555z"></path></svg>
                        </span>
                        </a>
                        <a rel="noreferrer" href="https://twitter.com/OLX_Pakistan" target="_blank">
                        <span>
                            <svg viewBox="0 0 1024 1024" fill="rgba(0,47,52,.64)"><path d="M511.979 85.321c235.648 0 426.667 191.019 426.667 426.667s-191.019 426.667-426.667 426.667c-235.605 0-426.667-191.019-426.667-426.667s191.061-426.667 426.667-426.667zM511.979 150.601c-199.595 0-361.429 161.792-361.429 361.387 0 199.637 161.835 361.429 361.429 361.429 199.637 0 361.429-161.792 361.429-361.429 0-199.595-161.792-361.387-361.429-361.387zM600.499 335.040c25.728 0 51.499 9.6 67.584 25.728 16.085 0 45.013-9.643 57.899-19.328-6.443 19.328-25.771 41.813-38.613 51.499 22.528 0 44.971-9.685 51.456-12.885-12.843 16.085-25.728 32.171-45.013 45.056 6.4 144.768-109.397 263.851-260.608 263.851-51.499 0-99.755-12.885-148.011-38.656 64.341 9.685 119.040-22.528 135.125-38.613-41.856 0-80.427-35.371-83.669-61.141 9.685 0 28.971 3.243 38.656-3.2-54.699-12.885-70.784-54.699-70.784-86.869 9.643 9.685 32.128 9.685 41.813 9.685-32.171-19.328-54.699-70.827-28.971-119.040 48.256 57.899 122.283 90.069 193.067 93.269-3.243-6.4-3.243-12.885-3.243-19.285 0-48.256 41.856-90.069 93.312-90.069z"></path></svg>
                        </span>
                        </a>
                        <a rel="noreferrer" href="https://www.youtube.com/channel/UCARDDjJnW7IRBpo_AP7WTHQ?sub_confirmation=1" target="_blank">
                        <span>
                            <svg viewBox="0 0 1024 1024" fill="rgba(0,47,52,.64)"><path d="M512 85.321c235.648 0 426.667 191.019 426.667 426.667s-191.019 426.667-426.667 426.667c-235.648 0-426.667-191.019-426.667-426.667s191.019-426.667 426.667-426.667zM512 150.601c-199.595 0-361.429 161.792-361.429 361.387 0 199.637 161.835 361.429 361.429 361.429s361.429-161.792 361.429-361.429c0-199.595-161.835-361.387-361.429-361.387zM382.605 321.86l311.125 190.123-311.125 190.165v-380.288z"></path></svg>
                        </span>
                        </a>
                        <a rel="noreferrer" href="https://www.instagram.com/olx.pakistan/" target="blank">
                        <span>
...
function BottomFooter(){
    return(
        <div className="bottom_footer_cont">
            <div className="my_row">
                <div className="botfot_col">
                    <section>
